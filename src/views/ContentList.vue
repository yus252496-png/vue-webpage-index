        ...
        <div class="filter-section">
          ...
          <div class="filter-grid">
            ...
            <div class="filter-group">
              <label>日期范围</label>
              <div class="select-wrapper">
                <select v-model="filters.dateRange" class="select">
                  <option value="">全部</option>
        ...
        <div class="data-section">
          ...
          <div class="table-container">
            <table class="table">
              ...
              <tbody>
                <tr v-for="item in filteredData" :key="item.id" class="row">
                  ...
                  <td class="cell-actions">
                    <button class="action-icon edit" @click="editItem(item)">
                      <span>◈</span>
                    </button>
                    <button class="action-icon delete" @click="deleteItem(item)">
                      <span>◊</span>
                    </button>
                  </td>
                </tr>
...
.btn-refresh:hover {
  ...
  box-shadow: 0 0 20px rgba(255, 234, 0, 0.3) !important;
}
